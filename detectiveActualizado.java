...
public class CasoDetective {
    ...
    public static void main(String[] args) {
        ...
        Espia agente = new Espia("Tigre Oculto", 5, "estudiante");
        agente.reporteCamuflaje();
    }
}
...
class Espia {
    ...
    public Espia(String nombreClave, int clasesAsistidas, String perfilFalso) {
        this.nombreClave = nombreClave;
        this.clasesAsistidas = clasesAsistidas;
        this.perfilFalso = perfilFalso;
    }

    public void reporteCamuflaje() {
        System.out.println("El agente " + nombreClave + ", haciendose pasar por " + perfilFalso + ", asistio a " + clasesAsistidas + " clases.");
    }
}
